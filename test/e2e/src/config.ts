 ...
 * 
 * The Lambda function name is 'pricofy-geocode-de' for both dev and prod environments.
...
export function getConfig(): TestConfig {
  ...
  // The function is deployed as 'pricofy-geocode-de' in both dev and prod accounts
  const defaultFunctionName = 'pricofy-geocode-de';
