...
// PostalCodeProvider provides access to German postal code data.
...
//
// Parameters:
//   - postalCode: German postal code (5 digits, e.g., "10115")
//
// Returns:
...
//
// Parameters:
//   - postalCode: German postal code to validate (5 digits)
//
// Returns:
